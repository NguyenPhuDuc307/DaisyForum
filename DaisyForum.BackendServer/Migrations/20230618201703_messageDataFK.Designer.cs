...
namespace DaisyForum.BackendServer.Migrations
{
    ...
    [Migration("20230618201703_messageDataFK")]
    partial class messageDataFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DaisyForum.BackendServer.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<float>("NavigationScore")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("DaisyForum.BackendServer.Data.Entities.Message", b =>
                {
                    ...
                    b.HasOne("DaisyForum.BackendServer.Data.Entities.User", "ToUser")
                        .WithMany()
