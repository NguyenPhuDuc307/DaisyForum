...
export class KnowledgeBasesDetailComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.entityForm = this.fb.group({
      'categoryId': new UntypedFormControl('', Validators.compose([
        Validators.required
      ])),
      ...
      'problem': new UntypedFormControl('', Validators.compose([
        Validators.required
      ])),
      'stepToReproduce': new UntypedFormControl(''),
      'errorMessage': new UntypedFormControl(''),
      'workaround': new UntypedFormControl(''),
